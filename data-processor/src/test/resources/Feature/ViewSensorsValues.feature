Feature: Users can view the data related to the sensors in the WebUI
    As a user I want to be able to view the historic of measurements of one sensor in the WebUI

    Scenario: User access sensors measures without having already sensor ids
